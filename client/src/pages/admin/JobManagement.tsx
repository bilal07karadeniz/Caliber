              ...
              <tbody className="divide-y">
                {jobs.map((j) => (
                  <tr key={j.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-500 hidden md:table-cell">{j.employer?.companyProfile?.companyName || '-'}</td>
                    <td className="px-4 py-3 text-sm text-gray-500 hidden md:table-cell">{j.location}</td>
                    ...
                    <td className="px-4 py-3 space-x-1">
                      ...
                      <Button variant="ghost" size="sm" className="text-red-500" onClick={() => { if (confirm('Delete this job?')) handleAction(j.id, 'delete'); }}>Delete</Button>
                    </td>
                  </tr>
                ))}
              </tbody>
